...
#define	ZMEDIAQUEUE_CLIENTQUEUE_COUNT	( 10 )
	...
	typedef
		enum class _ZMEDIAQUEUE_CLIENTQUEUETYPE
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_MASK
	{
		ZMEDIAQUEUE_MASK_NONE = 0,
		ZMEDIAQUEUE_MASK_AUDIO = (1 << static_cast<int>(ZMEDIAQUEUE::ZMEDIAQUEUE_AUDIO)),
		ZMEDIAQUEUE_MASK_VIDEO = (1 << static_cast<int>(ZMEDIAQUEUE::ZMEDIAQUEUE_VIDEO)),
		ZMEDIAQUEUE_MASK_AUDIOPODCASTS = (1 << static_cast<int>(ZMEDIAQUEUE::ZMEDIAQUEUE_AUDIOPODCAST)),
		ZMEDIAQUEUE_MASK_TRANSIENTAUDIO = (1 << static_cast<int>(ZMEDIAQUEUE::ZMEDIAQUEUE_TRANSIENTAUDIO)),
		ZMEDIAQUEUE_MASK_RADIO = (1 << static_cast<int>(ZMEDIAQUEUE::ZMEDIAQUEUE_RADIO))
	} 	ZMEDIAQUEUE_MASK;

	typedef
		enum class _ZMEDIAQUEUE_NOTIFICATION
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_PLAYFLAGS
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_CONTENTSCHANGED
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_MOVEFLAGS
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_CLEANUP
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_RADIOREGION
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_RADIO_RTPLUS_CLASS
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_PLAYSTATE
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_PROGRESSIVEPLAYMODE
	{
	...
	typedef
		enum class _MEDIAITEM_VIDEO_ZOOM_MODE
	{
...
#define	ZMEDIAQUEUE_VIZDATA_WAVESLOTS	( 256 )
	...
	typedef
		enum class _ZMEDIAQUEUE_SEEKDIR
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_STATIONTEXT
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_STATIONGENRE
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_HDRADIO_STATUS
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_SEEKFLAGS
	{
...
#define	ZMEDIAQUEUE_MAX_VOLUME	( 0 )
	...
	typedef
		enum class _ZMEDIAQUEUE_STREAMDATA_HINTFLAGS
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_EQUALIZER_PRESET
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_FFTRESULTS
	{
...
#define	ZMQ_PROPERTY_AUDIO_BALANCE_OFFSET	( 10000 )
	...
	typedef
		enum class _ZMEDIAQUEUE_AUDIOENDPOINT
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_RADIO_ANTENNATYPE
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_PROPERTY
	{
	...
	typedef
		enum class _ZMEDIAQUEUE_CONNECTIVITY_PLAYABLE_COUNT
	{
