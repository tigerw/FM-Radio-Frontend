...
extern "C" {
	...
	typedef
		enum class _ZMEDIALIB_NOTIFICATIONTYPE
	{
...
#pragma warning(pop)
	typedef /* [v1_enum] */
		enum class _ZMEDIAITEM_ATTRIBUTE_TYPE
	{
	...
	typedef /* [v1_enum] */
		enum class _ZMEDIAITEM_INTATTRIBUTE
	{
		ZMEDIAITEM_INTATTRIBUTE_INVALID = static_cast<int>(ZMEDIAITEM_ATTRIBUTE_TYPE::ZMEDIAITEM_ATTRIBUTE_TYPE_INT),
	...
	typedef /* [v1_enum] */
		enum class _ZMEDIAITEM_USHORTATTRIBUTE
	{
		ZMEDIAITEM_USHORTATTRIBUTE_INVALID = static_cast<int>(ZMEDIAITEM_ATTRIBUTE_TYPE::ZMEDIAITEM_ATTRIBUTE_TYPE_USHORT),
	...
	typedef /* [v1_enum] */
		enum class _ZMEDIAITEM_UINTATTRIBUTE
	{
		ZMEDIAITEM_UINTATTRIBUTE_INVALID = static_cast<int>(ZMEDIAITEM_ATTRIBUTE_TYPE::ZMEDIAITEM_ATTRIBUTE_TYPE_UINT),
	...
	typedef /* [v1_enum] */
		enum class _ZMEDIAITEM_GUIDATTRIBUTE
	{
		ZMEDIAITEM_GUIDATTRIBUTE_INVALID = static_cast<int>(ZMEDIAITEM_ATTRIBUTE_TYPE::ZMEDIAITEM_ATTRIBUTE_TYPE_GUID),
	...
	typedef /* [v1_enum] */
		enum class _ZMEDIAITEM_STRINGATTRIBUTE
	{
		ZMEDIAITEM_STRINGATTRIBUTE_INVALID = static_cast<int>(ZMEDIAITEM_ATTRIBUTE_TYPE::ZMEDIAITEM_ATTRIBUTE_TYPE_STRING),
	...
	typedef /* [v1_enum] */
		enum class _ZMEDIAITEM_DATETIMEATTRIBUTE
	{
		ZMEDIAITEM_DATETIMEATTRIBUTE_INVALID = static_cast<int>(ZMEDIAITEM_ATTRIBUTE_TYPE::ZMEDIAITEM_ATTRIBUTE_TYPE_DATETIME),
	...
	typedef /* [v1_enum] */
		enum class _ZMEDIAITEM_BLOBATTRIBUTE
	{
		ZMEDIAITEM_BLOBATTRIBUTE_INVALID = static_cast<int>(ZMEDIAITEM_ATTRIBUTE_TYPE::ZMEDIAITEM_ATTRIBUTE_TYPE_BLOB),
	...
	typedef /* [v1_enum] */
		enum class _ZMEDIAITEM_RELATION
	{
		ZMEDIAITEM_RELATION_INVALID = static_cast<int>(ZMEDIAITEM_ATTRIBUTE_TYPE::ZMEDIAITEM_ATTRIBUTE_TYPE_RELATION),
	...
	typedef
		enum class _ZMEDIAITEM_THUMBTYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_VISIBILITY
	{
	...
	typedef
		enum class _ZMEDIALIB_WRITELOCK_TYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_QUICKLAUNCH_LIST
	{
	...
	typedef
		enum class _ZMEDIALIB_DISPOSITION
	{
	...
	typedef
		enum class _ZMEDIAITEM_SORTORDER
	{
	...
	enum class ESubscriptionObjectDownloadState
	{
	...
	typedef
		enum class _ZMEDIAITEM_VIDEOTYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_PODCASTTYPE
	{
	...
	typedef
		enum class _QUICKLAUNCH_ITEM_CONTEXT_TYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_AUDIOTYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_INBOXMSG_TYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_QUICKLAUNCH_ITEMTYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_MEDIACONTROLS_FLAGS
	{
	...
	typedef
		enum class _ZMEDIAITEM_VECTOR_DOWNLOAD_STATE
	{
...
#define	ZMEDIAITEM_ROOTFOLDER	( ( ZMEDIAITEM  )( DWORD  )(( ( static_cast<int>(ZMEDIAITEM_TYPE::ZMEDIAITEM_TYPE_FOLDER) << 24 )  | ( 0xffffffff & 0xffffff )  ) ) )

#define	ZMEDIAITEM_ROOTPICTUREALBUM	( ( ZMEDIAITEM  )( DWORD  )(( ( static_cast<int>(ZMEDIAITEM_TYPE::ZMEDIAITEM_TYPE_PICTUREALBUM) << 24 )  | ( 0xffffffff & 0xffffff )  ) ) )

#define	ZMEDIAITEM_FMRADIO	( ( ZMEDIAITEM  )( DWORD  )(( ( static_cast<int>(ZMEDIAITEM_TYPE::ZMEDIAITEM_TYPE_UNKNOWN) << 24 )  | ( 0xffffffff & 0xffffff )  ) ) )

#define	ZMEDIAITEM_LETTER_PERIOD	( ( ZMEDIAITEM  )( DWORD  )(( ( static_cast<int>(ZMEDIAITEM_TYPE::ZMEDIAITEM_TYPE_LETTER) << 24 )  | ( 0xfffffffe & 0xffffff )  ) ) )

#define	ZMEDIAITEM_LETTER_MISCELLANEOUS	( ( ZMEDIAITEM  )( DWORD  )(( ( static_cast<int>(ZMEDIAITEM_TYPE::ZMEDIAITEM_TYPE_LETTER) << 24 )  | ( 0xffffffff & 0xffffff )  ) ) )

	typedef
		enum class _ZMEDIAITEM_USERCARDFLAG
	{
	...
	typedef
		enum class _ZMEDIAITEM_INBOXMSGFLAG
	{
	...
	typedef
		enum class _ZMEDIAITEM_CARTFLAG
	{
	...
	typedef
		enum class _ZMEDIAITEM_USERCARDPLAYLIST_TYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_PLAYLIST_TYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_CHANNEL_STATUS
	{
	...
	typedef
		enum class _ZMEDIAITEM_CLIP_TYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_ACTIONFLAGS
	{
	...
	typedef
		enum class _ZMEDIAITEM_ACQUIRED_TYPE
	{
	...
	typedef
		enum class _ZMEDIAITEM_LICENSESTATE
	{
	...
	typedef
		enum class _ZMEDIAITEM_STREAMSTATUS
	{
	...
	typedef /* [v1_enum] */
		enum class _ZMEDIALIB_STORAGELOCATION_INDEXID
	{
	...
	typedef
		enum class _ZMEDIALIB_STORAGELOCATION_FLAG
	{
		ZMEDIALIB_STORAGELOCATION_FLAG_NONE = 0,
		ZMEDIALIB_STORAGELOCATION_FLAG_CLOUD = (1 << static_cast<int>(ZMEDIALIB_STORAGELOCATION_INDEXID::ZMEDIALIB_STORAGELOCATION_INDEXID_CLOUD)),
		ZMEDIALIB_STORAGELOCATION_FLAG_INTERNAL = (1 << static_cast<int>(ZMEDIALIB_STORAGELOCATION_INDEXID::ZMEDIALIB_STORAGELOCATION_INDEXID_INTERNAL)),
		ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_0 = (1 << static_cast<int>(ZMEDIALIB_STORAGELOCATION_INDEXID::ZMEDIALIB_STORAGELOCATION_INDEXID_EXTERNAL_0)),
		ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_1 = (1 << static_cast<int>(ZMEDIALIB_STORAGELOCATION_INDEXID::ZMEDIALIB_STORAGELOCATION_INDEXID_EXTERNAL_1)),
		ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_2 = (1 << static_cast<int>(ZMEDIALIB_STORAGELOCATION_INDEXID::ZMEDIALIB_STORAGELOCATION_INDEXID_EXTERNAL_2)),
		ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_3 = (1 << static_cast<int>(ZMEDIALIB_STORAGELOCATION_INDEXID::ZMEDIALIB_STORAGELOCATION_INDEXID_EXTERNAL_3))
	} 	ZMEDIALIB_STORAGELOCATION_FLAG;

	typedef
		enum class _ZMEDIALIB_STORAGE_TYPE
	{
	...
	typedef
		enum class _ZMEDIALIB_STORAGE_FILTER
	{
...
#define ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL (ZMEDIALIB_STORAGELOCATION_FLAG::ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_0 | \
		ZMEDIALIB_STORAGELOCATION_FLAG::ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_1 | \
		ZMEDIALIB_STORAGELOCATION_FLAG::ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_2 | \
		ZMEDIALIB_STORAGELOCATION_FLAG::ZMEDIALIB_STORAGELOCATION_FLAG_EXTERNAL_3)
...
#define ZMEDIALIB_STORAGELOCATION_FLAG_CLOUD_MASK (ZMEDIALIB_STORAGELOCATION_FLAG_CLOUD)
	...
	typedef
		enum class _ZMEDIALIB_SAVESONGOPERATION
	{
	...
	typedef
		enum class _ZMEDIALIB_SAVEUGCOPERATION
	{
	...
	typedef
		enum class _ZMEDIA_NOTIFICATIONTYPE
	{
